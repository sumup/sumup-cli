// Code generated by generate-operations from github.com/sumup/sumup-go v0.17.2. DO NOT EDIT.
// OpenAPI SHA-256: 65a93b57821333a273b1c50ac435b16808dedab3e0e27bd7d42b053cf1507b36

package apicommands

const (
	CatalogSDKModule      = "github.com/sumup/sumup-go"
	CatalogSDKVersion     = "v0.17.2"
	CatalogOpenAPIVersion = "1.0.0"
	CatalogSpecSHA256     = "65a93b57821333a273b1c50ac435b16808dedab3e0e27bd7d42b053cf1507b36"
)
...
var Operations = []Operation{
	...
	},
	{
		...
		Parameters: []Parameter{
			{Name: "checkout_id", Location: "path", Description: "Unique ID of the checkout resource.", Type: "string", Format: "", Required: true},
		},
	...
	},
	{
		...
		Parameters: []Parameter{
			{Name: "checkout_reference", Location: "query", Description: "Filters the list of checkout resources by the unique ID of the checkout.", Type: "string", Format: "", Required: false},
		},
	},
	{
		...
		Parameters: []Parameter{
			{Name: "merchant_code", Location: "path", Description: "The SumUp merchant code.", Type: "string", Format: "", Required: true},
	...
	},
	{
		...
		Parameters: []Parameter{
			{Name: "customer_id", Location: "path", Description: "Unique ID of the saved customer resource.", Type: "string", Format: "", Required: true},
	...
	},
	{
		...
		Parameters: []Parameter{
			{Name: "merchant_code", Location: "path", Description: "Merchant code of the account whose payouts should be listed.", Type: "string", Format: "", Required: true},
	...
	},
	{
		...
		Parameters: []Parameter{
			...
			{Name: "mid", Location: "query", Description: "Merchant code.", Type: "string", Format: "", Required: true},
			{Name: "tx_event_id", Location: "query", Description: "The ID of the transaction event (refund).", Type: "integer", Format: "", Required: false},
		},
	},
	{
	...
	},
	{
		...
		Parameters: []Parameter{
			{Name: "merchant_code", Location: "path", Description: "Merchant code of the account whose transaction should be retrieved.", Type: "string", Format: "", Required: true},
			...
			{Name: "foreign_transaction_id", Location: "query", Description: "External/foreign transaction id (passed by clients).", Type: "string", Format: "", Required: false},
			{Name: "client_transaction_id", Location: "query", Description: "Client transaction id.", Type: "string", Format: "", Required: false},
		},
	},
	{
		...
		Parameters: []Parameter{
			{Name: "merchant_code", Location: "path", Description: "Merchant code of the account whose transaction history should be listed.", Type: "string", Format: "", Required: true},
			{Name: "transaction_code", Location: "query", Description: "Retrieves the transaction resource with the specified transaction code.", Type: "string", Format: "", Required: false},
	...
	},
	{
		...
		Parameters: []Parameter{
			{Name: "merchant_code", Location: "path", Description: "Merchant code of the account that owns the payment to refund.", Type: "string", Format: "", Required: true},
			{Name: "transaction_id", Location: "path", Description: "Unique ID of the transaction.", Type: "string", Format: "", Required: true},
		},
		RequestBody: &RequestBody{Schema: "object", Required: false},
	},
}
